...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO projects (title, description, image, tags) VALUES (?, ?, ?, ?)");
    $stmt->execute([$title, $description, $image, $tags]);
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tags" name="tags" placeholder="e.g., UI Design, 3D, Motion">
                    </div>
